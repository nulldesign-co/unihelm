//! `ferrum-config` — rendering, validating and activating the files the panel
//! owns (spec §10.4).
//!
//! The contract this crate implements is the one that decides whether a
//! sysadmin can trust the panel:
//!
//! 1. Files Ferrum fully owns live in dedicated include directories and carry a
//!    hash header.
...
impl From<ConfigError> for FerrumError {
