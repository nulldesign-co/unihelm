...
mod tests {
    ...
    use ferrum_core::{Domain, Email, Role, SubscriptionId, UserId, Username};
    ...
    async fn fixture() -> Fixture {
        ...
        let mine = record(&db, my_site, "/home/ft_mine/sites/mine.example/public").await;
        let theirs = record(
            &db,
            their_site,
            "/home/ft_theirs/sites/theirs.example/public",
        )
        .await;
    ...
    async fn a_second_install_in_the_same_directory_is_a_conflict() {
        ...
        let err =
            f.db.create_wp_install(NewWpInstall {
                site_id: f.my_site,
                path: "/home/ft_mine/sites/mine.example/public".into(),
                version: None,
                db_id: None,
                auto_update: false,
            })
