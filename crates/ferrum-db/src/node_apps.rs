...
use ferrum_core::{AppName, SiteId, SubscriptionId, TenantPath, TenantScope};
...
mod tests {
    ...
    async fn deleting_the_proxy_site_leaves_the_app_alive_and_unpublished() {
        ...
        let site = db
            .create_site(NewSite {
                subscription_id: sub,
                domain: ferrum_core::Domain::parse("blog.example.com").unwrap(),
                site_type: SiteType::Proxy,
                php_version: None,
                root_dir: "/home/ft_x/apps/blog".into(),
