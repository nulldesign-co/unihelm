//! `ferrum-ipc` — the typed channel between the unprivileged web process and the
//! root agent (spec §5.3).
//!
...
//! (`ferrum dev ipc-tap`), self-delimiting, and trivially bounded.
//!
...
impl From<IpcError> for ferrum_core::FerrumError {
    fn from(e: IpcError) -> Self {
        ...
        ferrum_core::FerrumError::new(code, e.to_string())
    }
}
