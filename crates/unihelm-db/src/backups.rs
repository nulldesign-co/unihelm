...
//! a plaintext password. Sealing and opening happen in `unihelm_ops::backup`,
...
//!    ([`unihelm_core::Permission::BackupManage`] plus [`ScopeFilter::All`]).
...
pub enum BackupScope {
    /// The panel itself: its database, `/etc/unihelm` and the state directory
