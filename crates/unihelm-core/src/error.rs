...
pub type Result<T, E = UnihelmError> = std::result::Result<T, E>;
...
pub fn docs_table() -> String {
    ...
    out.push_str(concat!(
        ...
        "This file is generated from `unihelm_core::error::ErrorCode`. ",
        "Regenerate it with:\n\n",
        "```\n",
...
impl fmt::Display for UnihelmError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(f, "[{}] {}", self.code.code(), self.detail)
    }
}

impl std::error::Error for UnihelmError {}
