...
pub async fn user_create(
    ...
    let username = unihelm_core::DbName::parse(&body.username)
...
pub async fn user_drop(
    ...
    let username = unihelm_core::DbName::parse(&username)
        .map_err(|e| ApiError::new(e.with_field("username")))?;
...
pub async fn grant(
    ...
    let database = unihelm_core::DbName::parse(&body.database)
