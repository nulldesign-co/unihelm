...
//!   `unihelm_ops::branding::sniff_image`, which refuses SVG outright, and the
...
use unihelm_db::branding::{PANEL_DEFAULT, normalize_login_host};
use unihelm_db::{AssetKind, ResolvedBranding};
