...
#[openapi(
    ...
    paths(
        ...
        super::runtimes::set_default,
        super::stack::switch_webserver,
        super::stack::webserver_gaps,
        ...
        super::runtimes::docker_remove,
        super::runtimes::docker_logs,
        super::runtimes::docker_image_pull,
        super::runtimes::docker_image_remove,
        super::runtimes::docker_image_prune,
        super::runtimes::docker_volume_remove,
        ...
        super::sites::delete,
        super::sites::drift,
        super::sites::reprovision,
        super::sites::alias_add,
        super::sites::alias_remove,
        ...
        super::terminal::open,
        super::terminal::ws,
        super::terminal::keys_list,
        super::terminal::keys_add,
        super::terminal::keys_remove,
        super::alerts::events,
        ...
        super::dns::provider_get,
        super::dns::zones,
        super::dns::records_list,
        super::dns::record_create,
        super::dns::record_update,
        super::dns::record_delete,
        super::git::status,
        super::git::attach,
        super::git::detach,
        super::git::clone,
        super::git::pull,
        super::processes::list,
        super::processes::kill,
        super::users::list,
        super::users::create,
        super::users::set_role,
        super::users::set_status,
        super::users::delete,
        super::users::change_password,
        super::apps::build,
        super::runtimes::docker_templates,
        super::runtimes::docker_template_prepare,
    ...
    tags(
        ...
        (name = "tasks", description = "Long-running work: history, logs, cancel and retry"),
        (name = "terminal", description = "The web terminal's ticket and socket, and the per-account SSH key manager"),
