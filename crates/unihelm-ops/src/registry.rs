...
impl OpRegistry {
    ...
    pub fn new(services: Arc<Services>) -> Self {
        ...
        registry.register(crate::stack::Start);
        registry.register(crate::stack::Stop);
        ...
        registry.register(crate::nodeapp::Build);
        ...
        registry.register(crate::dns::ProviderGet);
        registry.register(crate::dns::ZonesList);
        registry.register(crate::dns::RecordsList);
        registry.register(crate::dns::RecordsCreate);
        registry.register(crate::dns::RecordsUpdate);
        registry.register(crate::dns::RecordsDelete);
        ...
        registry.register(crate::processes::List::live());
        registry.register(crate::processes::Kill::live());
        registry.register(crate::users::List);
        registry.register(crate::users::Create);
        registry.register(crate::users::RoleSet);
        registry.register(crate::users::StatusSet);
        registry.register(crate::users::Delete);
        registry.register(crate::git::Status);
        registry.register(crate::git::Attach);
        registry.register(crate::git::Detach);
        registry.register(crate::git::Clone);
        registry.register(crate::git::Pull);
        ...
        registry.register(crate::dockertemplates::List);
        registry.register(crate::dockertemplates::Prepare);
