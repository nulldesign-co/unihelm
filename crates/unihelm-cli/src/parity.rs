...
pub const COVERAGE: &[(&str, &[&str])] = &[
    ...
    ("alert.rules.delete", &["unihelm", "alert", "rules-delete", "service_down", "--target", "nginx"]),
    ("alert.rules.list", &["unihelm", "alert", "rules"]),
    ("alert.rules.set", &["unihelm", "alert", "rules-set", "load", "--threshold", "4"]),
    ("app.build", &["unihelm", "app", "build", "1"]),
    ...
    ("app.update", &["unihelm", "app", "update", "1", "--runtime", "python"]),
    ...
    ("dns.provider.get", &["unihelm", "dns", "provider"]),
    ("dns.provider.set", &["unihelm", "dns", "provider-set", "--label", "cf", "--token-stdin"]),
    ("dns.records.create", &["unihelm", "dns", "record", "create", "--zone", "example.com", "--kind", "A", "--name", "www", "--content", "203.0.113.10"]),
    ("dns.records.delete", &["unihelm", "dns", "record", "delete", "rec1", "--zone", "example.com", "--confirm-name", "www.example.com", "--confirm-content", "203.0.113.10"]),
    ("dns.records.list", &["unihelm", "dns", "record", "list", "--zone", "example.com"]),
    ("dns.records.update", &["unihelm", "dns", "record", "update", "rec1", "--zone", "example.com", "--kind", "A", "--name", "www", "--content", "203.0.113.11", "--confirm-name", "www.example.com", "--confirm-content", "203.0.113.10"]),
    ("dns.zones.list", &["unihelm", "dns", "zones"]),
    ("docker.create", &["unihelm", "docker", "create", "nginx", "--name", "web"]),
    ("docker.image.prune", &["unihelm", "docker", "image", "prune"]),
    ("docker.image.pull", &["unihelm", "docker", "image", "pull", "nginx:alpine"]),
    ("docker.image.remove", &["unihelm", "docker", "image", "remove", "nginx:alpine"]),
    ("docker.list", &["unihelm", "docker", "list"]),
    ("docker.logs", &["unihelm", "docker", "logs", "web"]),
    ("docker.remove", &["unihelm", "docker", "remove", "web"]),
    ("docker.restart", &["unihelm", "docker", "restart", "web"]),
    ("docker.start", &["unihelm", "docker", "start", "web"]),
    ("docker.stop", &["unihelm", "docker", "stop", "web"]),
    ("docker.template.list", &["unihelm", "docker", "template", "list"]),
    ("docker.template.prepare", &["unihelm", "docker", "template", "prepare", "uptime-kuma"]),
    ("docker.volume.remove", &["unihelm", "docker", "volume", "remove", "app_data"]),
    ("engine.remove", &["unihelm", "engine", "remove", "mariadb"]),
    ("engine.status", &["unihelm", "engine", "status"]),
    ("fw.ban", &["unihelm", "firewall", "ban", "203.0.113.7"]),
    ("fw.bans", &["unihelm", "firewall", "bans"]),
    ("fw.disable", &["unihelm", "firewall", "disable"]),
    ("fw.enable", &["unihelm", "firewall", "enable"]),
    ...
    ("git.attach", &["unihelm", "git", "attach", "1", "https://github.com/owner/project.git"]),
    ("git.clone", &["unihelm", "git", "clone", "1"]),
    ("git.detach", &["unihelm", "git", "detach", "1"]),
    ("git.pull", &["unihelm", "git", "pull", "1"]),
    ("git.status", &["unihelm", "git", "status", "1"]),
    ...
    ("process.kill", &["unihelm", "process", "kill", "4123", "--command", "php-fpm", "--user", "uh_abc123"]),
    ("process.list", &["unihelm", "process", "list"]),
    ...
    ("runtime.default.set", &["unihelm", "runtime", "set-default", "php", "8.3"]),
    ...
    ("site.alias.add", &["unihelm", "site", "alias-add", "1", "www.example.com"]),
    ("site.alias.remove", &["unihelm", "site", "alias-remove", "1", "www.example.com"]),
    ...
    ("site.reprovision", &["unihelm", "site", "reprovision", "1"]),
    ...
    ("stack.start", &["unihelm", "stack", "start", "nginx"]),
    ("stack.status", &["unihelm", "stack", "status"]),
    ("stack.stop", &["unihelm", "stack", "stop", "nginx"]),
    ...
    ("user.create", &["unihelm", "account", "create", "newclient", "--email", "new@example.com", "--role", "customer", "--password-stdin"]),
    ("user.delete", &["unihelm", "account", "delete", "3", "--confirm-username", "newclient"]),
    ("user.list", &["unihelm", "account", "list"]),
    ("user.role.set", &["unihelm", "account", "role", "3", "reseller"]),
    ("user.status.set", &["unihelm", "account", "status", "3", "suspended"]),
    ...
    ("webserver.gaps", &["unihelm", "stack", "webserver-gaps", "apache"]),
    ("webserver.switch", &["unihelm", "stack", "webserver", "apache"]),
...
mod tests {
    ...
    fn secrets() -> Secrets {
        Secrets {
            ...
            account_password: Some("test-password".into()),
        }
    }
    ...
    fn every_planned_payload_parses_as_its_operation_s_input() {
        ...
        let mut checked = check! {
            ...
            "dns.provider.get" => dns::ProviderGetInput,
            "dns.provider.set" => dns::ProviderSetInput,
            "dns.records.create" => dns::RecordsCreateInput,
            "dns.records.delete" => dns::RecordsDeleteInput,
            "dns.records.list" => dns::RecordsListInput,
            "dns.records.update" => dns::RecordsUpdateInput,
            "dns.zones.list" => dns::ZonesListInput,
            "docker.template.list" => dockertemplates::ListInput,
            "docker.template.prepare" => dockertemplates::PrepareInput,
            "engine.remove" => engine::RemoveInput,
            "engine.status" => engine::StatusInput,
            ...
            "git.attach" => git::AttachInput,
            "git.clone" => git::CloneInput,
            "git.detach" => git::DetachInput,
            "git.pull" => git::PullInput,
            "git.status" => git::StatusInput,
            ...
            "process.kill" => processes::KillInput,
            "process.list" => processes::ListInput,
            "quota.backend" => quota::BackendInput,
            "quota.set" => quota::SetInput,
            "quota.usage" => quota::UsageInput,
            "docker.create" => docker::CreateInput,
            "docker.image.prune" => docker::ImagePruneInput,
            "docker.image.pull" => docker::ImageInput,
            "docker.image.remove" => docker::ImageInput,
            "docker.volume.remove" => docker::VolumeInput,
            "docker.list" => docker::ListInput,
            "runtime.default.set" => runtime_default::SetDefaultInput,
            "user.create" => users::CreateInput,
            "user.delete" => users::DeleteInput,
            "user.list" => users::ListInput,
            "user.role.set" => users::RoleSetInput,
            "user.status.set" => users::StatusSetInput,
            "webserver.switch" => webserver::SwitchInput,
            "webserver.gaps" => webserver::GapsInput,
            "fw.enable" => fwops::EnableInput,
            "fw.disable" => fwops::DisableInput,
            "docker.stop" => docker::ContainerInput,
            "docker.start" => docker::ContainerInput,
            "docker.restart" => docker::ContainerInput,
            "docker.remove" => docker::ContainerInput,
            "docker.logs" => docker::LogsInput,
            ...
            "site.alias.add" => site::AliasAddInput,
            "site.alias.remove" => site::AliasRemoveInput,
            "site.list" => site::ListInput,

            "site.reprovision" => site::ReprovisionInput,
            ...
            "stack.start" => stack::ServiceInput,
            "stack.status" => stack::StatusInput,
            "stack.stop" => stack::ServiceInput,
