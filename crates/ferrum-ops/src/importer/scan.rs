...
fn bad_archive(e: impl std::fmt::Display) -> FerrumError {
    FerrumError::new(
...
pub fn restage_subtree(
    ...
    let finish = builder
        ...
        .map_err(|e| FerrumError::new(ErrorCode::Internal, format!("staging archive: {e}")));
...
fn safe_err(e: crate::fsops::safepath::SafeError) -> FerrumError {
    FerrumError::new(ErrorCode::InvalidInput, e.message)
}
