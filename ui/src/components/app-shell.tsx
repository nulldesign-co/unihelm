...
import { Archive, BellRing, Boxes, Clock, Database, FolderOpen, Gauge, Globe, Languages, Layers, ListChecks, LogOut, Mail, Monitor, Moon, Network, Palette, ShieldCheck, Sun, TerminalSquare, Wallet } from "lucide-react";
